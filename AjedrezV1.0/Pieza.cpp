...
//tablerillooo q es esto
int tablerillo[8][8] = { {6,1,0,0,0,0,7,12},
						  {5,1,0,0,0,0,7,11},
						  {4,1,0,0,0,0,7,10},
						  {3,1,0,0,0,0,7,9 },
						  {2,1,0,0,0,0,7,8 },
...
Pieza::Pieza(unsigned short int t) {
	tipo = t;
	if (tipo < 7) color = 0; //Color blanco
	else color = 1; //Color negro
...
bool Pieza::MovimTorreVert(int posicion, int posicionnueva, int otraposicion, int piezabajamia, int piezaaltamia, int piezabajarival, int piezaaltarival) {
	int i, j;

	for (j = posicion + 1; j <= posicionnueva; j++)
	{

		if (tablerillo[otraposicion][j] > piezabajamia && tablerillo[otraposicion][j] < piezaaltamia && j <= posicionnueva)
		{
			cout << "movimiento no valido" << endl;
			return 0;
		}
		else if (tablerillo[otraposicion][j] > piezabajarival && tablerillo[otraposicion][j] < piezaaltarival && j < posicionnueva)
		{
			cout << "movimiento no valido" << endl;
			return 0;
		}
...
bool Pieza::MovimTorreHor(int posicion, int posicionnueva, int otraposicion, int piezabajamia, int piezaaltamia, int piezabajarival, int piezaaltarival)
{
	int i, j;
	for (j = posicion + 1; j <= posicionnueva; j++)
	{

		if (tablerillo[j][otraposicion] > piezabajamia && tablerillo[j][otraposicion] < piezaaltamia && j <= posicionnueva)
		{
			cout << "movimiento no valido" << endl;
			return 0;
		}
		else if (tablerillo[j][otraposicion] > piezabajarival && tablerillo[j][otraposicion] < piezaaltarival && j < posicionnueva)
		{
			cout << "movimiento no valido" << endl;
			return 0;
		}
...
bool Pieza::MovimAlfil1(int posicion, int posicionnueva, int otraposicion, int piezabajamia, int piezaaltamia, int piezabajarival, int piezaaltarival)
{
	int l, k;
	l = otraposicion + 1;
	for (k = posicion + 1; k <= posicionnueva; k++)
	{

		if (tablerillo[l][k] > piezabajamia && tablerillo[l][k] < piezaaltamia && k <= posicionnueva)
		{
			cout << "movimiento no valido" << endl;
			return 0;
		}
		else if (tablerillo[l][k] > piezabajarival && tablerillo[l][k] < piezaaltarival && k < posicionnueva)
		{
			cout << "movimiento no valido" << endl;
			return 0;
		}
...
bool Pieza::MovimAlfil2(int posicion, int posicionnueva, int otraposicion, int piezabajamia, int piezaaltamia, int piezabajarival, int piezaaltarival)
{
	int l, k;
	l = otraposicion - 1;
	for (k = posicion + 1; k <= posicionnueva; k++)
